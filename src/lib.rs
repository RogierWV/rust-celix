...
pub mod gen {
    ...
    pub enum Struct__dyn_message_type { }
    pub type dyn_message_type = Struct__dyn_message_type;
    #[repr(C)]
    #[derive(Copy)]
    ...
    pub type __WAIT_STATUS = Union_Unnamed38;
    #[repr(C)]
    #[derive(Copy)]
    ...
    pub type div_t = Struct_Unnamed39;
    #[repr(C)]
    #[derive(Copy)]
    ...
    pub type ldiv_t = Struct_Unnamed40;
    #[repr(C)]
    #[derive(Copy)]
    ...
    pub type lldiv_t = Struct_Unnamed41;
    ...
    pub type __sigset_t = Struct_Unnamed42;
    ...
    pub type fd_set = Struct_Unnamed43;
